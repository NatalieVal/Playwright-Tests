...
test('@refactored has title', async ({ page }) => {
...
test('@refactored @reusingToken deleting an article', async({page, request}) => {
...
test('@refactored @reusingToken create article using UI and delete it using API', async ({page, request}) => {
